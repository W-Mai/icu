...
if [ -n "${ICU_TOOL_DOWNLOAD_URL:-}" ]; then
    ...
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/W-Mai/icu/releases/download/v0.11.1"
elif [ -n "${ICU_TOOL_INSTALLER_GITHUB_BASE_URL:-}" ]; then
    INSTALLER_BASE_URL="$ICU_TOOL_INSTALLER_GITHUB_BASE_URL"
    ARTIFACT_DOWNLOAD_URLS="${INSTALLER_BASE_URL}/W-Mai/icu/releases/download/v0.11.1"
else
    ARTIFACT_DOWNLOAD_URLS="https://github.com/W-Mai/icu/releases/download/v0.11.1"
fi
...
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.32.0"},"source":{"app_name":"icu_tool","name":"icu","owner":"W-Mai","release_type":"github"},"version":"0.11.1"}
EORECEIPT
...
The installer for icu_tool 0.11.1

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/W-Mai/icu/releases/download/v0.11.1
...
download_binary_and_run_installer() {
    ...
    case "$_artifact_name" in 
        "icu_tool-aarch64-apple-darwin.tar.xz")
            ...
            _checksum_value="397106d314fee020821bc25a3cf594007ee769b5776cf13d9761c865fe921202"
            _bins="icu"
            _bins_js_array='"icu"'
            _libs=""
            _libs_js_array=""
        ...
        "icu_tool-aarch64-unknown-linux-gnu.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="7909bbdd03f24d0d5326a1c685d119d624a97cef667d311c4c4c28519ac0587b"
            _bins="icu"
            _bins_js_array='"icu"'
            _libs=""
            _libs_js_array=""
        ...
        "icu_tool-aarch64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="2254b4813db9b141231f2d8db4e99ac22b22b87f080f859575ace468a2c2ddf0"
            _bins="icu"
            _bins_js_array='"icu"'
            _libs=""
            _libs_js_array=""
        ...
        "icu_tool-x86_64-apple-darwin.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="93fed3ade0f7248f84cc79179341ba7cfa13a57ccad221cf4b93dfec095f0f18"
            _bins="icu"
            _bins_js_array='"icu"'
            _libs=""
            _libs_js_array=""
        ...
        "icu_tool-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="30888c21ca0265801376bbb9bc612c2801464eaa4e6552dcf2fdc07ec62492bd"
            _bins="icu.exe"
        ...
        "icu_tool-x86_64-unknown-linux-gnu.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="304b462259ed303e262c46f53fd6ea350ec848e576af1644c7ae5eb14de919b6"
            _bins="icu"
            _bins_js_array='"icu"'
            _libs=""
            _libs_js_array=""
        ...
        "icu_tool-x86_64-unknown-linux-musl.tar.xz")
            ...
            _zip_ext=".tar.xz"
            _checksum_style="sha256"
            _checksum_value="5c3fc0d92f0a4cc07b383fe6fc89478b02fb6d38b4b8d11bf190cf53aa6587b0"
            _bins="icu"
            _bins_js_array='"icu"'
            _libs=""
            _libs_js_array=""
