...
pub fn draw_convert_options(ui: &mut egui::Ui, state: &mut ViewerState) {
    ...
    crate::image_viewer::ui::widgets::section_header(ui, &t!("output_format"));
    ui.add_space(4.0);
    ...
    if state.context.convert_params.output_format == ImageFormat::LVGL {
        crate::image_viewer::ui::widgets::section_header(ui, "LVGL Settings");
        ui.add_space(4.0);
    ...
    if state.context.convert_params.output_format == ImageFormat::MIRX {
        crate::image_viewer::ui::widgets::section_header(ui, "MIRX Settings");
        ui.add_space(4.0);
        param_row(ui, t!("color_format").as_ref(), |ui| {
